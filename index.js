...
cmd_stc_public = '7144'
//set_sticker_command//
var nomor_ovo = `kosong`
var nomor_dana = `kosong`
var nomor_gopay = `kosong`
var qr_code_ovo = 'https://k.top4top.io/p_2169lwa2o0.jpeg'
var qr_code_dana = 'https://k.top4top.io/p_2169lwa2o0.jpeg'
var qr_code_gopay = 'https://k.top4top.io/p_2169lwa2o0.jpeg'

var _minggu = 'Rp 10.000,00'
...
zeksApikey = 'purokta'
ApiZeks = 'apOZe09vdtq7f4rtOjAtPdNvuzI'
...
img = setting.img
baper = '𝓜𝓪𝓼 𝓟𝓾𝓻🌈'
apiku = 'https://youtu.be/5Jp9-ibLo_A'
gc_wa_lu = 'https://chat.whatsapp.com/GJs45OMokDgCj5O4cpJpf4'
...
const reply2 = (teks) => {
            alpha.sendMessage(from, teks, text, {quoted: mek, contextInfo: {"forwardingScore":90,"isForwarded":true},sendEphemeral: true})
        }
// Auto Read Group 
...
await alpha.updatePresence(from, Presence.composing)
	...
	return admins
		...
		const ratee = ["𝓢𝓲𝓮𝓼𝓽 𝓫𝓸𝓽","𝓢𝓲𝓮𝓼𝓽 𝓫𝓸𝓽","𝓢𝓲𝓮𝓼𝓽 𝓫𝓸𝓽","𝓢𝓲𝓮𝓼𝓽 𝓫𝓸𝓽","𝓢𝓲𝓮𝓼𝓽 𝓫𝓸𝓽","𝓢𝓲𝓮𝓼𝓽 𝓫𝓸𝓽","𝓢𝓲𝓮𝓼𝓽 𝓫𝓸𝓽"]
...
const bayarLimit = (sender, amount) => {
	...
	//FUCNTION GOPLANET BY RIPAI
	   ...
	   //FUCNTION mining coal
        ...
        if(time2 < "23:59:00"){
        var ucapannya2 = `sugeng dalu🪐 ${pushname}`
}
        if(time2 < "19:00:00"){
        var ucapannya2 = `sugeng dalu🪐 ${pushname}`
}
        if(time2 < "18:00:00"){
        var ucapannya2 = `sugeng sonten🌅 ${pushname}`
}
        if(time2 < "15:00:00"){
        var ucapannya2 = `sugeng siang💃 ${pushname}`
}
        if(time2 < "11:00:00"){
        var ucapannya2 = `sugeng enjing🥀 ${pushname}`
}
        if(time2 < "05:00:00"){
        var ucapannya2 = `sugeng dalu🪐 ${pushname}`
}
...
if (autobio === false) return           
    ...
    if (new Date() * 1 - settingstatus > 1000) {
      ...
      await alpha.setStatus(`𝓜𝓪𝓼 𝓟𝓾𝓻🩸 | Runtime ${uptimer} ⏲️ | ${status}`).catch((_) => _);
...
const bugtrol = { 
       ...
       const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "6289523258649-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: fs.readFileSync(`image/${thumbnail}`), surface: 200, message: `𝓜𝓪𝓼 𝓟𝓾𝓻🩸`, orderTitle: '𝓜𝓪𝓼 𝓟𝓾𝓻', sellerJid: '0@s.whatsapp.net'}},contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
        ...
        const fgif = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title":`𝓢𝓲𝓮𝓼𝓽 𝓫𝓸𝓽`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `𝓢𝓲𝓮𝓼𝓽 𝓫𝓸𝓽`, 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`)}}}
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": "P", "caption": `${pushname}\n𝓜𝓪𝓼 𝓟𝓾𝓻🩸`, 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`)}}}
...
let papakpo = [{
								...
								sendButLocation(from, userProcfile , `𝓢𝓲𝓮𝓼𝓽 𝓫𝓸𝓽 by @${koko.split('@')[0]}`,pp_userz, papakpo, {contextInfo: { mentionedJid: [sender]}})
}
break
...
let papako = [{
	...
	case 'menu': case 'help':
			try {
				...
				chatt = 'https://b.top4top.io/p_2169tx6im0.jpg'
				}
...
`
if(menusimple == false){
sendButDoc(from, ini_anu, `𝙾𝚓𝚘 𝚜𝚙𝚊𝚖 𝚓𝚒𝚊𝚗𝚌𝚘𝚔 𝚔𝚘 𝚗𝚍𝚊𝚔 𝚎𝚛𝚘𝚛𝚛𝚛\n𝟻 𝚜𝚎𝚌𝚘𝚗𝚍\n@${koko.split('@')[0]} `, sender, koko, ini_mark)
...
break
                ...
                let papao = [{
								...
								sendButLocation(from, allmenu(prefix, wita, wit, ucapannya2 , timuu, status, wa_version, mcc, mnc, os_version, device_manufacturer, device_model, alfa , alfa1, thisDay, ini_tanggal, totalchat, hit_today, ini_gcchat), `𝓢𝓲𝓮𝓼𝓽 𝓫𝓸𝓽 by @${koko.split('@')[0]}`,pp_userz, papao, {})
                break
        case 'trigger':
...
case 'bcgif':
         ...
         ini_ownerNumber = [`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`]
					...
					var ini_gopayy =`Halo @${sender.split("@")[0]} *kulo cok owner e nak ra sv jo di pencet juh*`
var buttonss = [
...
case 'setexif':
		    ...
		    case 'colong':
		            ...
		            dua = typeof anu[1] !== 'undefined' ? anu[1] : `𝓜𝓪𝓼 𝓟𝓾𝓻 OFC`
...
break
		...
		if (!isQuotedSticker) return reply('Reply stc nya!')
					...
					fakethumb(buffer,'```Nih kak, jgn lupa save nomer owner```')
					fs.unlinkSync(ran)
					})
					break
        ...
        break;
           ...
           case 'getpp':
				if (mek.message.extendedTextMessage != undefined){
					...
					anuu  = {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `${numbernye}@s.whatsapp.net`, 'remoteJid': '6289523258649-1604595598@g.us', 'quotedMessage': {"imageMessage": {"caption": `「𝓜𝓪𝓼 𝓟𝓾𝓻」`, 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`)}}}}
...
if (budy.includes("eror",'error','Eror','Error')){
					...
					alpha.sendMessage(from, daieeeee, sticker, { contextInfo: {mentionedJid: [sender]}, quoted: { "key": { "participant": `${numbernye}@s.whatsapp.net`, "remoteJid":  '6283136505591-1614953337@g.us', "fromMe": false, "id": "B391837A58338BA8186C47E51FFDFD4A" }, "message": { "documentMessage": { "jpegThumbnail": fs.readFileSync(`image/${thumbnail}`), "mimetype": "application/octet-stream","title": "@${koko.split('@')[0]}", "fileLength": "36", "pageCount": 0, "fileName": `Kenapa bisa error???`}}, "messageTimestamp": "1614069378", "status": "PENDING"}})
		        }
